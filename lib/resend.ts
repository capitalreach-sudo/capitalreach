...
export async function sendSubscribeWelcomeEmail(to: string) {
  return send(
    ...
    `<div style="font-family:'DM Sans',Arial,sans-serif;color:#1A1612;max-width:520px">
      <p style="font-size:12px;letter-spacing:.08em;text-transform:uppercase;color:#B2621B">◆ CapitalReach</p>
      ...
      <p style="margin-top:20px"><a href="${brand.url}/blog" style="display:inline-block;background:#B2621B;color:#fff;text-decoration:none;padding:10px 18px;border-radius:4px;font-size:13px;font-weight:600">Read the Dispatch →</a></p>
    </div>`,
